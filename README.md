...
- **Analysis**: `results/analysis/<analysis_name>/...` (e.g. `failure_rate/<use_case>/<time_dir>/`, `workflow_type_sensitivity/sequential/12h/fr0/` or `.../fork/12h/fr0/`, `target_job_length/<use_case>/fr0/`, `data_transfer_rate/sequential/fr0/` or `.../fork/fr0/`, `construction_metrics/<use_case>/12h/fr0|fr5|fr25/100MBps/`)
