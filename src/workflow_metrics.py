...
class WorkflowMetricsCalculator:
    ...
    def _calculate_total_wall_time(self) -> float:
        ...
        # This would be calculated from actual execution timestamps
        # For now, return execution time as placeholder
    ...
    def print_metrics(self, detailed: bool = False) -> None:
        ...
        print(f"Total Execution Time: {self.metrics.total_execution_time:.2f} seconds")
